...
const getDataTemplate = () => {
    return {
        ...
        // placeURL: `/assets/place/floor.glb`,
        ...
        ...{
            playerRotY: -1.2167,
            playerStart: [-0.756, 0.8, 8.061],
            cameraStart: [-2.093, 12, 28.362],
        },
...
//         {
//             name: 'swat',
//             avatarURL: `/assets/non-rpm/ava/swat-transform.glb`,
//             avatarBoneFix: true,
//             avatarScale: 1.0,
//             avatarOffsetY: -0.85,
//             avatarRotX: Math.PI * 0.5,
//         },
//     ]
